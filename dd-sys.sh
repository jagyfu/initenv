...
echo "  2) CentOS 6 (腾讯云镜像) 用户名：root 密码：MoeClub.org"
...
case $N in
  ...
  2) bash InstallNET.sh -c 6.9 -v 64 -a --mirror 'https://mirrors.cloud.tencent.com/centos-vault' --ip-addr $MAINIP --ip-gate $GATEWAYIP --ip-mask $SUBNET ;;
